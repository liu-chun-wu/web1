<div style="width:99%; height:87%; margin:auto; overflow:auto; border:#666 1px solid;">
    ...
    <form method="post" action="api/edit.php">
            ...
            <tbody>
                ...
                ?>
                    <tr class="cent">
                        ...
                        <td><input type="button" value="更換圖片" onclick="op('#cover','#cvr','modal/upload_image.php?id=<?= $row['id']; ?>&table=<?= $table; ?>')">
                        </td>
        ...
        <table style="margin-top:40px; width:70%;">
            <tbody>
                <tr>
                    <td width="200px"><input type="button" onclick="op('#cover','#cvr','modal/image.php?table=<?= $table; ?>')" value="新增校園映像圖片"></td>
